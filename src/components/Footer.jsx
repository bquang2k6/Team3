...
const Footer = () => {
    return (
        <footer className="px-4 lg:px-40 py-20 border-t border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-background-dark/50 transition-colors duration-300">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                <div className="col-span-1 md:col-span-1">
                    ...
                    <div className="flex gap-4">
                        <a className="text-slate-400 hover:text-primary dark:text-white/40 dark:hover:text-white transition-colors" href="#"><span className="material-symbols-outlined">public</span></a>
                        <a className="text-slate-400 hover:text-primary dark:text-white/40 dark:hover:text-white transition-colors" href="#"><span className="material-symbols-outlined">share</span></a>
            ...
            <div className="mt-5 -mb-16 pt-8 border-t border-slate-200 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-6">
                    <a className="text-slate-500 hover:text-primary dark:text-white/20 dark:hover:text-white text-xs" href="#">Điều khoản sử dụng</a>
                    <a className="text-slate-500 hover:text-primary dark:text-white/20 dark:hover:text-white text-xs" href="#">Chính sách bảo mật</a>
                    <a className="text-slate-500 hover:text-primary dark:text-white/20 dark:hover:text-white text-xs" href="#">Cookie dữ liệu</a>
                </div>
            </div>
        </footer>
    );
